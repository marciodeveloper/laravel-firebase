...
<head>
    ...
    <title>CRUD Laravel usando Firebase</title>
    <!-- Bootstrap CSS -->
...
<body>
    <div class="container" style="margin-top: 50px;">
        <h4 class="text-center">CRUD Laravel usando Firebase</h4><br>
        ...
        <div class="card card-default">
            <div class="card-body">
                <form id="addUser" class="form-inline" method="POST" action="">
                    ...
                    <button id="submitUser" type="button" class="btn btn-primary mb-2">Enviar</button>
                </form>
            </div>
        </div>
        <br>
